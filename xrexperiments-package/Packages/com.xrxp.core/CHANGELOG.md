...
### Added
- Initial release of XR Experiments (XRXP) package
- Core functionality: XRXPManager, XRXPConfig, XRXPException
- Recording system: XRXPRecorder, DataManager, XRXPObjectTracker
- Data storage backends: LocalStorage, BackupStorage, RemoteStorage
